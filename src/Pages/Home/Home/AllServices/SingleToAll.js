...
const SingleToAll = ({ service }) => {
    const { title, popularity, review, author, price, description, img } = service;
    return (
        <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-900 dark:text-gray-100">
            <div className="flex space-x-4">
                ...
                <div className="flex flex-col space-y-1">
                    <a rel="noopener noreferrer" href="#" className="text-sm font-semibold">{author.company.website}</a>
                    <span className="text-xs dark:text-gray-400">{popularity.count} hours ago</span>
                </div>
            </div>
            <div>
