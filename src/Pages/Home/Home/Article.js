...
const Article = () => {
    return (
        <article className="w-3/4 px-6 py-24 my-10 mx-auto space-y-12 dark:bg-gray-900 dark:text-gray-100">
            <div className="w-full mx-auto space-y-4 text-center">
                <p className="text-xs font-semibold tracking-wider uppercase">Feature Article</p>
                <h1 className="text-4xl font-bold leading-tight md:text-5xl">This is vary admirable article Written By Lorony Jenkins.</h1>
