        ...
        <div className=' dark:bg-gray-900 dark:text-gray-100'>
            ...
            <div className="w-3/4 md:w-1/2 lg:w-1/2 p-8 space-y-3 mx-auto dark:bg-gray-900 dark:text-gray-100">
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <button onClick={handleGihubSignIn} aria-label="Log in with GitHub" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account? Please
